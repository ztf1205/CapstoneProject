...
public class LookAround : MonoBehaviour
{
    public struct CameraShot
    {
        ...
        public CameraShot(Vector3 position, Quaternion rotation, Vector3 up, float filedOfView)
        {
            this.position = position;
            this.rotation = rotation;
            this.up = up;
            this.filedOfView = filedOfView;
        }
    }
    ...
    private void UpdateShot()
    {
        ...
        cam.fieldOfView = Mathf.Lerp(cam.fieldOfView, currentShot.filedOfView, fovResponse*Time.deltaTime);
    }
