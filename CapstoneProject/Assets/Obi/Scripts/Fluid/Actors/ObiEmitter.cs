...
namespace Obi
{
    ...
    public class ObiEmitter : ObiActor
    {
        ...
        private void ResetParticle(int index, float offset)
        {
            ...
            Vector3 positionOffset = spawnVelocity * offset;
        ...
        public override void PrepareStep(float stepTime)
        {
            base.PrepareStep(stepTime);
            ...
            if (m_IsEmitting || pooledParticles > Mathf.FloorToInt(minPoolSize * particleCount))
            {
                ...
                if (emissionMethod == EmissionMethod.STREAM)
                {
                    ...
                    float burstCount = speed * stepTime / particleSize;
                    ...
                    while (unemittedBursts >= 1)
                    {
                        ...
                        float offset = unemittedBursts * particleSize;
